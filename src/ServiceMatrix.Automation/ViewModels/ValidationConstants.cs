namespace NServiceBusStudio.Automation.ViewModels
{
    static class ValidationConstants
    {
        ...
        public const string InvalidIdentifierMessage = "The value entered is not properly formatted. Accepted values are valid class identifier names. As a general guideline for Commands use active verbs, for example, SubmitOrder. For Events, use past tense, for example, OrderSubmitted.";
