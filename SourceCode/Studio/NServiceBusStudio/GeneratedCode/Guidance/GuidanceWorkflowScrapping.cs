        ...
        private List<Tuple<string, string, string>> Items
        {
            get
            {
                return new List<Tuple<string, string, string>>()
                {
                    ...
                    Tuple.Create ("Getting Started", "NServiceBus Videos", "http://particular.net/Contents/Item/Display/183"),
                    ...
                    Tuple.Create ("Day to Day", "Staying Updated With NuGet", "http://particular.net/Contents/Item/Display/252"),
                    ...
                    Tuple.Create ("Management And Monitoring", "Auditing With NServiceBus", "http://particular.net/Contents/Item/Display/206"),
                    ...
                    Tuple.Create ("Scaling Out", "The Gateway And Multi-Site Distribution", "http://particular.net/Contents/Item/Display/208"),
