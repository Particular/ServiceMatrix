...
namespace NServiceBus.Modeling.EndpointDesign
{
	...
	/// </summary>
	internal partial class EndpointDesignDocView : EndpointDesignDocViewBase
	{
		/// <summary>
		/// Constructs a new EndpointDesignDocView.
		/// </summary>
		public EndpointDesignDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class EndpointDesignDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new EndpointDesignDocView.
		/// </summary>
		protected EndpointDesignDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			EndpointDesignDocDataBase docData = this.DocData as EndpointDesignDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for EndpointDesignDocViewBase should be an EndpointDesignDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::NServiceBus.Modeling.EndpointDesign.EndpointDesignDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::NServiceBus.Modeling.EndpointDesign.EndpointDesignDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::NServiceBus.Modeling.EndpointDesign.EndpointDesignToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::NServiceBus.Modeling.EndpointDesign.EndpointDesignToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.EndpointDesignDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::NServiceBus.Modeling.EndpointDesign.EndpointDesignHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::NServiceBus.Modeling.EndpointDesign.EndpointDesignHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::NServiceBus.Modeling.EndpointDesign.EndpointDesignHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
