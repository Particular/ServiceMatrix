...
namespace NServiceBus.Modeling.EndpointDesign
{
	...
	/// </summary>
	internal partial class EndpointDesignDocData : EndpointDesignDocDataBase
	{
		/// <summary>
		/// Constructs a new EndpointDesignDocData.
		/// </summary>
		public EndpointDesignDocData(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) 
	...
	/// <summary>
	/// Class which represents a EndpointDesign document in memory.
	/// </summary>
	internal abstract partial class EndpointDesignDocDataBase : DslShell::ModelingDocData
	{
		...
		/// <summary>
		/// Constructs a new EndpointDesignDocDataBase.
		/// </summary>
		protected EndpointDesignDocDataBase(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) : base(serviceProvider, editorFactoryId)
		{
		}
		...
		protected override string FormatList
		{
			get
			{
				return global::NServiceBus.Modeling.EndpointDesign.EndpointDesignDomainModel.SingletonResourceManager.GetString("FormatList"); 
			}
		}
		...
		protected virtual bool HandleBindingFailure(global::System.Exception exception)
		{
			...
			string errorMessage = string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
				global::NServiceBus.Modeling.EndpointDesign.EndpointDesignDomainModel.SingletonResourceManager.GetString("BindingErrorOccurred"),
				exception.ToString());
		...
		{
			return new DslShell::VsValidationController(this.ServiceProvider, typeof(EndpointDesignExplorerToolWindow));
		}
		/// <summary>
		...
		protected override global::System.Collections.Generic.IList<global::System.Type> GetDomainModels()
		{
			...
			allTypes.Add(typeof(global::NServiceBus.Modeling.EndpointDesign.EndpointDesignDomainModel));
		...
		protected virtual global::System.Collections.Generic.IEnumerable<global::System.Type> GetExtensionDomainModels()
		{
			...
			global::System.Collections.Generic.IEnumerable<global::System.Type> extensionDomainModels = this.ExtensionLocator.GetExtendingDomainModels(typeof(global::NServiceBus.Modeling.EndpointDesign.EndpointDesignDomainModel));
		...
		protected override void Load(string fileName, bool isReload)
		{
			...
			global::NServiceBus.Modeling.EndpointDesign.EndpointModel modelRoot = null;
			...
			global::NServiceBus.Modeling.EndpointDesign.EndpointDesignDomainModel.EnableDiagramRules(this.Store);
			string diagramFileName = fileName + this.DiagramExtension;
			
			modelRoot = global::NServiceBus.Modeling.EndpointDesign.EndpointDesignSerializationHelper.Instance.LoadModelAndDiagram(serializationResult, this.GetModelPartition(), fileName, this.GetDiagramPartition(), diagramFileName, schemaResolver, null /* no load-time validation */, this.SerializerLocator);
			...
			{	
				...
				throw new global::System.InvalidOperationException(global::NServiceBus.Modeling.EndpointDesign.EndpointDesignDomainModel.SingletonResourceManager.GetString("CannotOpenDocument"));
			}
			else
			{
						...
						if (itemId != global::Microsoft.VisualStudio.VSConstants.VSITEMID_NIL)
						{
							...
							if (this.diagramDocumentLockHolder == null)
							{
								throw new global::System.InvalidOperationException(string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
													global::NServiceBus.Modeling.EndpointDesign.EndpointDesignDomainModel.SingletonResourceManager.GetString("CannotCloseExistingDiagramDocument"),
													diagramFileName));
							}
						}
					}
		...
		protected override bool CanSave(bool allowUserInterface)
		{
			...
			if (allowUserInterface)
			{
				...
				if (vc.ErrorMessages.Count != 0)
				{
					...
					global::System.Windows.Forms.DialogResult result = DslShell::PackageUtility.ShowMessageBox(this.ServiceProvider, global::NServiceBus.Modeling.EndpointDesign.EndpointDesignDomainModel.SingletonResourceManager.GetString(errorMsg), VSShellInterop::OLEMSGBUTTON.OLEMSGBUTTON_YESNO, VSShellInterop::OLEMSGDEFBUTTON.OLEMSGDEFBUTTON_SECOND, VSShellInterop::OLEMSGICON.OLEMSGICON_WARNING);
		...
		{
			DslModeling::SerializationResult serializationResult = new DslModeling::SerializationResult();
			global::NServiceBus.Modeling.EndpointDesign.EndpointModel modelRoot = (global::NServiceBus.Modeling.EndpointDesign.EndpointModel)this.RootElement;
			...
			{
				global::NServiceBus.Modeling.EndpointDesign.EndpointDesignDiagram diagram = diagrams[0] as global::NServiceBus.Modeling.EndpointDesign.EndpointDesignDiagram;
				if (diagram != null)
				{
					string diagramFileName = fileName + this.DiagramExtension;
					try
					{
						...
						global::NServiceBus.Modeling.EndpointDesign.EndpointDesignSerializationHelper.Instance.SaveModelAndDiagram(serializationResult, modelRoot, fileName, diagram, diagramFileName, this.Encoding, false);
					}
					finally
					{
			...
			{
				global::NServiceBus.Modeling.EndpointDesign.EndpointDesignSerializationHelper.Instance.SaveModel(serializationResult, modelRoot, fileName, this.Encoding, false);
			}
			// Report serialization messages.
			this.SuspendErrorListRefresh();
			try
			...
			if (serializationResult.Failed)
			{	// Save failed.
				throw new global::System.InvalidOperationException(global::NServiceBus.Modeling.EndpointDesign.EndpointDesignDomainModel.SingletonResourceManager.GetString("CannotSaveDocument"));
			}
		}
		/// <summary>
			...
			if (diagrams.Count > 0)
			{
				...
				if (diagram != null)
				{
					try
					{
						...
						global::NServiceBus.Modeling.EndpointDesign.EndpointDesignSerializationHelper.Instance.SaveDiagram(serializationResult, diagram, fileName, this.Encoding, false);
					}
					finally
					{
		...
		protected override string SerializedModel
		{
			get
			{
				global::NServiceBus.Modeling.EndpointDesign.EndpointModel modelRoot = this.RootElement as global::NServiceBus.Modeling.EndpointDesign.EndpointModel;
				string modelFile = string.Empty;
				if (modelRoot != null)
				{
					modelFile = global::NServiceBus.Modeling.EndpointDesign.EndpointDesignSerializationHelper.Instance.GetSerializedModelString(modelRoot, this.Encoding);
				}
				return modelFile;
			}
		}
