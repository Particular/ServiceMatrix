...
namespace NServiceBus.Modeling.EndpointDesign
{
	...
	/// </summary>
	internal partial class EndpointDesignCommandSet : EndpointDesignCommandSetBase
	{
		/// <summary>
		/// Constructs a new EndpointDesignCommandSet.
		/// </summary>
		public EndpointDesignCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class EndpointDesignCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new EndpointDesignCommandSetBase.
		/// </summary>
		protected EndpointDesignCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewEndpointDesignExplorerCommand,
				typeof(EndpointDesignEditorFactory).GUID);
		...
		{
			EndpointDesignExplorerToolWindow explorer = this.EndpointDesignExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		{
			if (this.CurrentEndpointDesignDocData != null && this.CurrentEndpointDesignDocData.Store != null)
			{
				this.CurrentEndpointDesignDocData.ValidationController.Validate(this.CurrentEndpointDesignDocData.GetAllElementsForValidation(), DslValidation::ValidationCategories.Menu);
			}
		}
		...
		internal virtual void OnMenuValidate(object sender, global::System.EventArgs e)
		{
			if (this.CurrentEndpointDesignDocData != null && this.CurrentEndpointDesignDocData.Store != null)
			{
				...
				this.CurrentEndpointDesignDocData.ValidationController.Validate(elementList, DslValidation::ValidationCategories.Menu);
			}
		}
		...
		protected EndpointDesignDocData CurrentEndpointDesignDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as EndpointDesignDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected EndpointDesignDocView CurrentEndpointDesignDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as EndpointDesignDocView;
			}
		}
		...
		/// </summary>
		protected EndpointDesignExplorerToolWindow EndpointDesignExplorerToolWindow
		{
			get
			{
				EndpointDesignExplorerToolWindow explorerWindow = null;
				DslShell::ModelingPackage package = this.ServiceProvider.GetService(typeof(VSShell::Package)) as DslShell::ModelingPackage;

				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(EndpointDesignExplorerToolWindow), true) as EndpointDesignExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				EndpointDesignExplorerToolWindow explorerWindow = this.EndpointDesignExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class EndpointDesignClipboardCommandSet : EndpointDesignClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new EndpointDesignClipboardCommandSet.
		/// </summary>
		public EndpointDesignClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class EndpointDesignClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new EndpointDesignClipboardCommandSetBase.
		/// </summary>
		protected EndpointDesignClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
