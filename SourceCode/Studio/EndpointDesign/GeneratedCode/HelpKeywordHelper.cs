...
namespace NServiceBus.Modeling.EndpointDesign
{
	...
	/// </remarks>
	public partial class EndpointDesignHelpKeywordHelper : EndpointDesignHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new EndpointDesignHelpKeywordHelper.
		/// </summary>
		protected EndpointDesignHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the EndpointDesignHelpKeywordHelper.
		/// </summary>
		public static EndpointDesignHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class EndpointDesignHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new EndpointDesignHelpKeywordHelperBase.
		/// </summary>
		protected EndpointDesignHelpKeywordHelperBase()
			: base() { }
