...
[module: global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Maintainability", "CA1506:AvoidExcessiveClassCoupling", Scope = "type", Target = "NServiceBus.Modeling.EndpointDesign.EndpointDesignDiagram")]

namespace NServiceBus.Modeling.EndpointDesign
{
	/// <summary>
	/// DomainClass EndpointDesignDiagram
	/// Description for NServiceBus.Modeling.EndpointDesign.EndpointDesignDiagram
	/// </summary>
	[DslDesign::DisplayNameResource("NServiceBus.Modeling.EndpointDesign.EndpointDesignDiagram.DisplayName", typeof(global::NServiceBus.Modeling.EndpointDesign.EndpointDesignDomainModel), "NServiceBus.Modeling.EndpointDesign.GeneratedCode.DomainModelResx")]
	[DslDesign::DescriptionResource("NServiceBus.Modeling.EndpointDesign.EndpointDesignDiagram.Description", typeof(global::NServiceBus.Modeling.EndpointDesign.EndpointDesignDomainModel), "NServiceBus.Modeling.EndpointDesign.GeneratedCode.DomainModelResx")]
	[DslModeling::DomainModelOwner(typeof(global::NServiceBus.Modeling.EndpointDesign.EndpointDesignDomainModel))]
	[global::System.CLSCompliant(true)]
	[DslModeling::DomainObjectId("b6fa988a-9a81-4e59-8960-eb357c6aae1d")]
	public partial class EndpointDesignDiagram : DslDiagrams::Diagram
	{
		...
		private static global::System.ComponentModel.ToolboxItemFilterAttribute[] toolboxFilters = new global::System.ComponentModel.ToolboxItemFilterAttribute[] {
					new global::System.ComponentModel.ToolboxItemFilterAttribute(global::NServiceBus.Modeling.EndpointDesign.EndpointDesignToolboxHelperBase.ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) };
		...
		{
			if(element is global::NServiceBus.Modeling.EndpointDesign.SendReceiveEndpoint)
			{
				global::NServiceBus.Modeling.EndpointDesign.SendReceiveEndpointShape newShape = new global::NServiceBus.Modeling.EndpointDesign.SendReceiveEndpointShape(this.Partition);
				if(newShape != null) newShape.Size = newShape.DefaultSize; // set default shape size
				return newShape;
			}
			if(element is global::NServiceBus.Modeling.EndpointDesign.SendEndpoint)
			{
				global::NServiceBus.Modeling.EndpointDesign.SendEndpointShape newShape = new global::NServiceBus.Modeling.EndpointDesign.SendEndpointShape(this.Partition);
				if(newShape != null) newShape.Size = newShape.DefaultSize; // set default shape size
				return newShape;
			}
			...
			if(element is global::NServiceBus.Modeling.EndpointDesign.EventsAreProcessedBySendReceiveEndpoints)
			{
				global::NServiceBus.Modeling.EndpointDesign.ProcessConnector newShape = new global::NServiceBus.Modeling.EndpointDesign.ProcessConnector(this.Partition);
				return newShape;
			}
			if(element is global::NServiceBus.Modeling.EndpointDesign.CommandIsProcessedBySendReceiveEndpoint)
			{
				global::NServiceBus.Modeling.EndpointDesign.ProcessConnector newShape = new global::NServiceBus.Modeling.EndpointDesign.ProcessConnector(this.Partition);
				return newShape;
			}
			if(element is global::NServiceBus.Modeling.EndpointDesign.SendEndpointEmitsCommands)
			{
				global::NServiceBus.Modeling.EndpointDesign.EmitConnector newShape = new global::NServiceBus.Modeling.EndpointDesign.EmitConnector(this.Partition);
				return newShape;
			}
			if(element is global::NServiceBus.Modeling.EndpointDesign.SendReceiveEndpointEmitsEvents)
			{
				global::NServiceBus.Modeling.EndpointDesign.EmitConnector newShape = new global::NServiceBus.Modeling.EndpointDesign.EmitConnector(this.Partition);
				return newShape;
			}
			if(element is global::NServiceBus.Modeling.EndpointDesign.SendReceiveEndpointEmitCommands)
			{
				global::NServiceBus.Modeling.EndpointDesign.EmitConnector newShape = new global::NServiceBus.Modeling.EndpointDesign.EmitConnector(this.Partition);
				return newShape;
			}
		...
		protected override void InitializeShapeFields(global::System.Collections.Generic.IList<DslDiagrams::ShapeField> shapeFields)
		{
			...
			global::NServiceBus.Modeling.EndpointDesign.CommandShape.DecoratorsInitialized += CommandShapeDecoratorMap.OnDecoratorsInitialized;
			global::NServiceBus.Modeling.EndpointDesign.EventShape.DecoratorsInitialized += EventShapeDecoratorMap.OnDecoratorsInitialized;
			global::NServiceBus.Modeling.EndpointDesign.SendReceiveEndpointShape.DecoratorsInitialized += SendReceiveEndpointShapeDecoratorMap.OnDecoratorsInitialized;
			global::NServiceBus.Modeling.EndpointDesign.SendEndpointShape.DecoratorsInitialized += SendEndpointShapeDecoratorMap.OnDecoratorsInitialized;
		}
		
		/// <summary>
		/// Class containing decorator path traversal methods for CommandShape.
		/// </summary>
		internal static partial class CommandShapeDecoratorMap
		{
			/// <summary>
			/// Event handler called when decorator initialization is complete for CommandShape.  Adds decorator mappings for this shape or connector.
			/// </summary>
		...
		/// <summary>
		/// Class containing decorator path traversal methods for EventShape.
		/// </summary>
		internal static partial class EventShapeDecoratorMap
		{
			/// <summary>
			/// Event handler called when decorator initialization is complete for EventShape.  Adds decorator mappings for this shape or connector.
			/// </summary>
			public static void OnDecoratorsInitialized(object sender, global::System.EventArgs e)
			{
				DslDiagrams::ShapeElement shape = (DslDiagrams::ShapeElement)sender;
		...
		/// <summary>
		/// Class containing decorator path traversal methods for SendReceiveEndpointShape.
		/// </summary>
		internal static partial class SendReceiveEndpointShapeDecoratorMap
		{
			/// <summary>
			/// Event handler called when decorator initialization is complete for SendReceiveEndpointShape.  Adds decorator mappings for this shape or connector.
			/// </summary>
			public static void OnDecoratorsInitialized(object sender, global::System.EventArgs e)
			{
				DslDiagrams::ShapeElement shape = (DslDiagrams::ShapeElement)sender;
		...
		/// <summary>
		/// Class containing decorator path traversal methods for SendEndpointShape.
		/// </summary>
		internal static partial class SendEndpointShapeDecoratorMap
		{
			/// <summary>
			/// Event handler called when decorator initialization is complete for SendEndpointShape.  Adds decorator mappings for this shape or connector.
			/// </summary>
			public static void OnDecoratorsInitialized(object sender, global::System.EventArgs e)
			{
				DslDiagrams::ShapeElement shape = (DslDiagrams::ShapeElement)sender;
		...
		private global::NServiceBus.Modeling.EndpointDesign.ProcessConnectAction processConnectAction;
		private global::NServiceBus.Modeling.EndpointDesign.EmitConnectAction emitConnectAction;
		/// <summary>
		...
		public override void OnViewMouseEnter(DslDiagrams::DiagramPointEventArgs pointArgs)
		{
			...
			if(activeView != null)
			{
				...
				if (SelectedToolboxItemSupportsFilterString(activeView, global::NServiceBus.Modeling.EndpointDesign.EndpointDesignToolboxHelper.ProcessFilterString))
				{
					if (this.processConnectAction == null)
					{
						this.processConnectAction = new global::NServiceBus.Modeling.EndpointDesign.ProcessConnectAction(this);
						this.processConnectAction.MouseActionDeactivated += new DslDiagrams::MouseAction.MouseActionDeactivatedEventHandler(OnConnectActionDeactivated);
					}
					action = this.processConnectAction;
				} 
				else if (SelectedToolboxItemSupportsFilterString(activeView, global::NServiceBus.Modeling.EndpointDesign.EndpointDesignToolboxHelper.EmitFilterString))
				{
					if (this.emitConnectAction == null)
					{
						this.emitConnectAction = new global::NServiceBus.Modeling.EndpointDesign.EmitConnectAction(this);
						this.emitConnectAction.MouseActionDeactivated += new DslDiagrams::MouseAction.MouseActionDeactivatedEventHandler(OnConnectActionDeactivated);
					}
					action = this.emitConnectAction;
				} 
				else
				{
					action = null;
		...
		protected override void Dispose(bool disposing)
		{
			try
			{
				if(disposing)
				{
					if(this.processConnectAction != null)
					{
						this.processConnectAction.Dispose();
						this.processConnectAction = null;
					}
					if(this.emitConnectAction != null)
					{
						this.emitConnectAction.Dispose();
						this.emitConnectAction = null;
					}
				}
			}
			finally
		...
		/// <summary>
		/// EndpointDesignDiagram domain class Id.
		/// </summary>
		public static readonly new global::System.Guid DomainClassId = new global::System.Guid(0xb6fa988a, 0x9a81, 0x4e59, 0x89, 0x60, 0xeb, 0x35, 0x7c, 0x6a, 0xae, 0x1d);
		/// <summary>
		/// Constructor
		/// </summary>
		/// <param name="store">Store where new element is to be created.</param>
		/// <param name="propertyAssignments">List of domain property id/value pairs to set once the element is created.</param>
		public EndpointDesignDiagram(DslModeling::Store store, params DslModeling::PropertyAssignment[] propertyAssignments)
		...
		/// <param name="propertyAssignments">List of domain property id/value pairs to set once the element is created.</param>
		public EndpointDesignDiagram(DslModeling::Partition partition, params DslModeling::PropertyAssignment[] propertyAssignments)
...
namespace NServiceBus.Modeling.EndpointDesign
{
		...
		internal sealed partial class FixUpDiagram : FixUpDiagramBase
		{
			...
			public override void ElementAdded(DslModeling::ElementAddedEventArgs e)
			{
				...
				{
					parentElement = GetParentForCommand((global::NServiceBus.Modeling.EndpointDesign.Command)childElement);
				} else
				if(childElement is global::NServiceBus.Modeling.EndpointDesign.Event)
				{
					parentElement = GetParentForEvent((global::NServiceBus.Modeling.EndpointDesign.Event)childElement);
				} else
				{
					parentElement = null;
				}
			...
			public static global::NServiceBus.Modeling.EndpointDesign.EndpointModel GetParentForCommand( global::NServiceBus.Modeling.EndpointDesign.Command root )
			{
				// Segments 0 and 1
				global::NServiceBus.Modeling.EndpointDesign.EndpointModel result = root.EndpointModel;
				if ( result == null ) return null;
				return result;
			}
			public static global::NServiceBus.Modeling.EndpointDesign.EndpointModel GetParentForEvent( global::NServiceBus.Modeling.EndpointDesign.Event root )
			{
				// Segments 0 and 1
				global::NServiceBus.Modeling.EndpointDesign.EndpointModel result = root.EndpointModel;
				if ( result == null ) return null;
			...
			public static global::NServiceBus.Modeling.EndpointDesign.EndpointModel GetParentForSendReceiveEndpoint( global::NServiceBus.Modeling.EndpointDesign.Endpoint root )
			{
				// Segments 0 and 1
				global::NServiceBus.Modeling.EndpointDesign.EndpointModel result = root.EndpointModel;
				if ( result == null ) return null;
			...
			public static global::NServiceBus.Modeling.EndpointDesign.EndpointModel GetParentForSendEndpoint( global::NServiceBus.Modeling.EndpointDesign.Endpoint root )
			{
				// Segments 0 and 1
				global::NServiceBus.Modeling.EndpointDesign.EndpointModel result = root.EndpointModel;
				if ( result == null ) return null;
		...
		/// </summary>
		[DslModeling::RuleOn(typeof(global::NServiceBus.Modeling.EndpointDesign.NamedElement), InitiallyDisabled=true)]
		internal sealed class DecoratorPropertyChanged : DslModeling::ChangeRule
		{
			...
			public override void ElementPropertyChanged(DslModeling::ElementPropertyChangedEventArgs e)
			{
				...
				if (e.DomainProperty.Id == global::NServiceBus.Modeling.EndpointDesign.NamedElement.NameDomainPropertyId)
				{
					DslDiagrams::Decorator decorator = global::NServiceBus.Modeling.EndpointDesign.CommandShape.FindCommandShapeDecorator("NameDecorator");
					if(decorator != null)
					{
		...
		internal sealed class ConnectorRolePlayerChanged : DslModeling::RolePlayerChangeRule
		{
			...
			public override void RolePlayerChanged(DslModeling::RolePlayerChangedEventArgs e)
			{
				...
				foreach (DslDiagrams::PresentationViewsSubject connectorLink in connectorLinks)
				{
					...
					if (linkShape != null)
					{
						global::NServiceBus.Modeling.EndpointDesign.EndpointDesignDiagram diagram = linkShape.Diagram as global::NServiceBus.Modeling.EndpointDesign.EndpointDesignDiagram;
						if (diagram != null)
						{
